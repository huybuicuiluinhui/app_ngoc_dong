...
const tabs = {
  ...
  "/coins": {
    label: "Điểm thưởng",
    icon: Images.iconCoin,
    activeIcon: Images.iconCoinActive,
  },
  "/phone": {
    label: "Tư vấn",
    icon: Images.iconPhoneTab,
    activeIcon: Images.iconPhoneTab,
  },
  "/noti": {
    label: "Thông báo",
    icon: Images.iconNoti,
    activeIcon: Images.iconNoti,
  },
  "/profile": {
    label: "Tài khoản",
...
export const BOTTOM_NAVIGATION_PAGES = ["/", "/coins", "noti", "/profile"];
          ...
          >
            ...
            {Object.keys(tabs).map((path: TabKeys, index) => (
              ...
              >
                ...
                <span
                  className={`text-align text-[11px]  ${
                    path === activeTab
            ...
            <div className="absolute w-16 h-16 rounded-full overflow-hidden flex items-center -top-7 z-[10] left-1/2 -translate-x-1/2 self-center justify-center bg-white">
